...
function merge_default(context) {
  var selection4 = context.selection ? context.selection() : context;
...
function count(node) {
  ...
  if (!i) sum2 = 1;
  else while (--i >= 0) sum2 += children4[i].value;
  node.value = sum2;
}
...
function eachBefore_default(callback, that) {
  var node = this, nodes = [node], children4, i, index = -1;
...
function eachAfter_default(callback, that) {
  var node = this, nodes = [node], next = [], children4, i, n, index = -1;
  while (node = nodes.pop()) {
    next.push(node);
    if (children4 = node.children) {
...
function sum_default(value) {
  return this.eachAfter(function(node) {
    var sum2 = +value(node.data) || 0, children4 = node.children, i = children4 && children4.length;
    while (--i >= 0) sum2 += children4[i].value;
    node.value = sum2;
  });
}
...
function* iterator_default2() {
  var node = this, current, next = [node], children4, i, n;
  do {
...
function hierarchy(data, children4) {
  ...
  var root4 = new Node(data), node, nodes = [root4], child, childs, i, n;
  while (node = nodes.pop()) {
...
function treemap_default() {
  ...
  function treemap(root4) {
    ...
    paddingStack = [0];
    if (round) root4.eachBefore(round_default);
    return root4;
  }
...
function arrayAll2(select) {
  return function() {
    ...
    return group == null ? [] : array_default2(group);
  };
}
function selectAll_default3(select) {
  if (typeof select === "function") select = arrayAll2(select);
...
function data_default2(value, key) {
  if (!arguments.length) return Array.from(this, datum2);
  ...
  for (var m = groups.length, update = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
    var parent = parents[j], group = groups[j], groupLength = group.length, data = array_default2(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
    bind(parent, group, enterGroup, updateGroup, exitGroup, data, key);
    for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) {
      if (previous = enterGroup[i0]) {
        if (i0 >= i1) i1 = i0 + 1;
...
function merge_default2(selection4) {
  if (!(selection4 instanceof Selection2)) throw new Error("invalid merge");
  for (var groups0 = this._groups, groups1 = selection4._groups, m0 = groups0.length, m1 = groups1.length, m = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m; ++j) {
    for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge2 = merges[j] = new Array(n), node, i = 0; i < n; ++i) {
      if (node = group0[i] || group1[i]) {
        merge2[i] = node;
...
function selectAll_default5(select) {
  if (typeof select === "function") select = arrayAll3(select);
  else select = selectorAll_default3(select);
  for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
    for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) {
      if (node = group[i]) {
        subgroups.push(select.call(node, node.__data__, i, group));
...
function enter_default3() {
  return new Selection3(this._enter || this._groups.map(sparse_default3), this._parents);
}
...
function data_default3(value, key) {
  if (!arguments.length) return Array.from(this, datum3);
  ...
  for (var m = groups.length, update = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
    var parent = parents[j], group = groups[j], groupLength = group.length, data = arraylike2(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
    bind(parent, group, enterGroup, updateGroup, exitGroup, data, key);
    for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) {
      if (previous = enterGroup[i0]) {
        if (i0 >= i1) i1 = i0 + 1;
...
function exit_default3() {
  return new Selection3(this._exit || this._groups.map(sparse_default3), this._parents);
}
...
function style_default3(name, value, priority) {
  return arguments.length > 1 ? this.each((value == null ? styleRemove3 : typeof value === "function" ? styleFunction3 : styleConstant3)(name, value, priority == null ? "" : priority)) : styleValue3(this.node(), name);
}
...
function text_default3(value) {
  return arguments.length ? this.each(value == null ? textRemove3 : (typeof value === "function" ? textFunction3 : textConstant3)(value)) : this.node().textContent;
}
...
Selection3.prototype = selection3.prototype = {
...
var selection_default3 = selection3;
...
function attr_default4(name, value) {
  var fullname = namespace_default3(name), i = fullname === "transform" ? interpolateTransformSvg : interpolate_default;
  return this.attrTween(name, typeof value === "function" ? (fullname.local ? attrFunctionNS4 : attrFunction4)(fullname, i, tweenValue(this, "attr." + name, value)) : value == null ? (fullname.local ? attrRemoveNS4 : attrRemove4)(fullname) : (fullname.local ? attrConstantNS4 : attrConstant4)(fullname, i, value));
}
...
function selectAll_default7(select) {
  ...
  for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
    for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) {
      if (node = group[i]) {
        for (var children4 = select.call(node, node.__data__, i, group), child, inherit3 = get2(node, id3), k = 0, l = children4.length; k < l; ++k) {
          if (child = children4[k]) {
            schedule_default(child, name, id3, k, children4, inherit3);
          }
        }
...
function styleMaybeRemove(id3, name) {
  ...
  return function() {
    var schedule = set2(this, id3), on = schedule.on, listener = schedule.value[key] == null ? remove4 || (remove4 = styleRemove4(name)) : void 0;
...
function style_default4(name, value, priority) {
  ...
  return value == null ? this.styleTween(name, styleNull(name, i)).on("end.style." + name, styleRemove4(name)) : typeof value === "function" ? this.styleTween(name, styleFunction4(name, i, tweenValue(this, "style." + name, value))).each(styleMaybeRemove(this._id, name)) : this.styleTween(name, styleConstant4(name, i, value), priority).on("end.style." + name, null);
}
...
function text_default4(value) {
  return this.tween("text", typeof value === "function" ? textFunction4(tweenValue(this, "text", value)) : textConstant4(value == null ? "" : value + ""));
}
...
var selection_prototype = selection_default3.prototype;
...
var elasticIn = (function custom9(a, p) {
  ...
  elasticIn3.amplitude = function(a2) {
...
var elasticOut = (function custom10(a, p) {
  ...
  elasticOut3.amplitude = function(a2) {
...
var elasticInOut = (function custom11(a, p) {
  ...
  elasticInOut3.amplitude = function(a2) {
...
selection_default3.prototype.interrupt = interrupt_default2;
selection_default3.prototype.transition = transition_default2;
...
var dispatch_default5 = dispatch2;

// node_modules/d3/node_modules/d3-drag/src/event.js
function DragEvent2(type2, {
  sourceEvent,
  subject,
  target,
  identifier,
...
var exponent2 = 3;
var polyIn2 = (function custom12(e) {
  e = +e;
  function polyIn3(t) {
    return Math.pow(t, e);
  }
  polyIn3.exponent = custom12;
  return polyIn3;
})(exponent2);
var polyOut2 = (function custom13(e) {
  e = +e;
  function polyOut3(t) {
    return 1 - Math.pow(1 - t, e);
  }
  polyOut3.exponent = custom13;
  return polyOut3;
})(exponent2);
var polyInOut2 = (function custom14(e) {
  e = +e;
  function polyInOut3(t) {
    return ((t *= 2) <= 1 ? Math.pow(t, e) : 2 - Math.pow(2 - t, e)) / 2;
  }
  polyInOut3.exponent = custom14;
  return polyInOut3;
})(exponent2);
...
var backIn2 = (function custom15(s) {
  s = +s;
  function backIn3(t) {
    return (t = +t) * t * (s * (t - 1) + t);
  }
  backIn3.overshoot = custom15;
  return backIn3;
})(overshoot2);
var backOut2 = (function custom16(s) {
  s = +s;
  function backOut3(t) {
    return --t * t * ((t + 1) * s + t) + 1;
  }
  backOut3.overshoot = custom16;
  return backOut3;
})(overshoot2);
var backInOut2 = (function custom17(s) {
  s = +s;
  function backInOut3(t) {
    return ((t *= 2) < 1 ? t * t * ((s + 1) * t - s) : (t -= 2) * t * ((s + 1) * t + s) + 2) / 2;
  }
  backInOut3.overshoot = custom17;
  return backInOut3;
})(overshoot2);
...
var amplitude2 = 1;
var period2 = 0.3;
var elasticIn2 = (function custom18(a, p) {
  var s = Math.asin(1 / (a = Math.max(1, a))) * (p /= tau4);
  function elasticIn3(t) {
    return a * tpmt2(- --t) * Math.sin((s - t) / p);
  }
  elasticIn3.amplitude = function(a2) {
    return custom18(a2, p * tau4);
  };
  elasticIn3.period = function(p2) {
    return custom18(a, p2);
  };
  return elasticIn3;
})(amplitude2, period2);
var elasticOut2 = (function custom19(a, p) {
  var s = Math.asin(1 / (a = Math.max(1, a))) * (p /= tau4);
  function elasticOut3(t) {
    return 1 - a * tpmt2(t = +t) * Math.sin((t + s) / p);
  }
  elasticOut3.amplitude = function(a2) {
    return custom19(a2, p * tau4);
  };
  elasticOut3.period = function(p2) {
    return custom19(a, p2);
  };
  return elasticOut3;
})(amplitude2, period2);
var elasticInOut2 = (function custom20(a, p) {
  var s = Math.asin(1 / (a = Math.max(1, a))) * (p /= tau4);
  function elasticInOut3(t) {
    return ((t = t * 2 - 1) < 0 ? a * tpmt2(-t) * Math.sin((s - t) / p) : 2 - a * tpmt2(t) * Math.sin((s + t) / p)) / 2;
  }
  elasticInOut3.amplitude = function(a2) {
    return custom20(a2, p * tau4);
  };
  elasticInOut3.period = function(p2) {
    return custom20(a, p2);
  };
  return elasticInOut3;
})(amplitude2, period2);
...
function text_default5(input, init3) {
...
function dsvParse(parse) {
  return function(input, init3, row) {
    ...
    return text_default5(input, init3).then(function(response) {
...
function parser(type2) {
  return (input, init3) => text_default5(input, init3).then((text) => new DOMParser().parseFromString(text, type2));
}
...
treeProto.data = data_default4;
treeProto.extent = extent_default;
treeProto.find = find_default2;
treeProto.remove = remove_default5;
treeProto.removeAll = removeAll;
treeProto.root = root_default;
treeProto.size = size_default4;
...
function longitude(point) {
  return abs3(point[0]) <= pi4 ? point[0] : sign(point[0]) * ((abs3(point[0]) + pi4) % tau5 - pi4);
}
function polygonContains_default(polygon, point) {
  ...
  var sum2 = new Adder();
  if (sinPhi === 1) phi2 = halfPi4 + epsilon4;
  else if (sinPhi === -1) phi2 = -halfPi4 - epsilon4;
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (var j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
      var point1 = ring[j], lambda1 = longitude(point1), phi1 = point1[1] / 2 + quarterPi, sinPhi1 = sin2(phi1), cosPhi1 = cos2(phi1), delta = lambda1 - lambda0, sign2 = delta >= 0 ? 1 : -1, absDelta = sign2 * delta, antimeridian = absDelta > pi4, k = sinPhi0 * sinPhi1;
      sum2.add(atan2(k * sign2 * sin2(absDelta), cosPhi0 * cosPhi1 + k * cos2(absDelta)));
      angle += antimeridian ? delta + sign2 * tau5 : delta;
...
function compareIntersection(a, b) {
  return ((a = a.x)[0] < 0 ? a[1] - halfPi4 - epsilon4 : halfPi4 - a[1]) - ((b = b.x)[0] < 0 ? b[1] - halfPi4 - epsilon4 : halfPi4 - b[1]);
}
...
mercatorRaw.invert = function(x2, y2) {
  return [x2, 2 * atan(exp(y2)) - halfPi4];
};
...
transverseMercatorRaw.invert = function(x2, y2) {
  return [-y2, 2 * atan(exp(x2)) - halfPi4];
};
...
var emptyOn2 = dispatch_default5("start", "end", "cancel", "interrupt");
var emptyTween2 = [];
var CREATED2 = 0;
var SCHEDULED2 = 1;
var STARTING2 = 2;
...
function create2(node, id3, self2) {
  ...
  function start3(elapsed) {
    var i, j, n, o;
    if (self2.state !== SCHEDULED2) return stop();
    for (i in schedules) {
      o = schedules[i];
      if (o.name !== self2.name) continue;
    ...
    self2.on.call("start", node, node.__data__, self2.index, self2.group);
    if (self2.state !== STARTING2) return;
...
function attrConstant5(name, interpolate, value1) {
  var string00, string1 = value1 + "", interpolate0;
  return function() {
    var string0 = this.getAttribute(name);
    return string0 === string1 ? null : string0 === string00 ? interpolate0 : interpolate0 = interpolate(string00 = string0, value1);
...
function attrConstantNS5(fullname, interpolate, value1) {
  var string00, string1 = value1 + "", interpolate0;
  return function() {
    var string0 = this.getAttributeNS(fullname.space, fullname.local);
    return string0 === string1 ? null : string0 === string00 ? interpolate0 : interpolate0 = interpolate(string00 = string0, value1);
...
function attrFunction5(name, interpolate, value) {
  var string00, string10, interpolate0;
  return function() {
    var string0, value1 = value(this), string1;
    if (value1 == null) return void this.removeAttribute(name);
...
function attrFunctionNS5(fullname, interpolate, value) {
  var string00, string10, interpolate0;
  return function() {
    var string0, value1 = value(this), string1;
    if (value1 == null) return void this.removeAttributeNS(fullname.space, fullname.local);
...
function attr_default5(name, value) {
  var fullname = namespace_default(name), i = fullname === "transform" ? interpolateTransformSvg : interpolate_default3;
  return this.attrTween(name, typeof value === "function" ? (fullname.local ? attrFunctionNS5 : attrFunction5)(fullname, i, tweenValue2(this, "attr." + name, value)) : value == null ? (fullname.local ? attrRemoveNS5 : attrRemove5)(fullname) : (fullname.local ? attrConstantNS5 : attrConstant5)(fullname, i, value));
}
...
function attrTweenNS2(fullname, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0) t0 = (i0 = i) && attrInterpolateNS2(fullname, i);
    return t0;
  }
  tween._value = value;
  return tween;
...
function attrTween2(name, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0) t0 = (i0 = i) && attrInterpolate2(name, i);
    return t0;
  }
  tween._value = value;
  return tween;
...
function on_default5(name, listener) {
  var id3 = this._id;
...
function selectAll_default8(select) {
  var name = this._name, id3 = this._id;
  if (typeof select !== "function") select = selectorAll_default(select);
  for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
    for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) {
      if (node = group[i]) {
        for (var children4 = select.call(node, node.__data__, i, group), child, inherit3 = get4(node, id3), k = 0, l = children4.length; k < l; ++k) {
          if (child = children4[k]) {
            schedule_default2(child, name, id3, k, children4, inherit3);
          }
        }
        subgroups.push(children4);
        parents.push(node);
...
var Selection5 = selection_default.prototype.constructor;
function selection_default5() {
  return new Selection5(this._groups, this._parents);
}
...
function styleConstant5(name, interpolate, value1) {
  var string00, string1 = value1 + "", interpolate0;
  return function() {
...
function styleFunction5(name, interpolate, value) {
  var string00, string10, interpolate0;
  return function() {
...
function styleMaybeRemove2(id3, name) {
  var on0, on1, listener0, key = "style." + name, event = "end." + key, remove4;
  return function() {
    var schedule = set4(this, id3), on = schedule.on, listener = schedule.value[key] == null ? remove4 || (remove4 = styleRemove5(name)) : void 0;
    if (on !== on0 || listener0 !== listener) (on1 = (on0 = on).copy()).on(event, listener0 = listener);
    schedule.on = on1;
  };
}
function style_default5(name, value, priority) {
  var i = (name += "") === "transform" ? interpolateTransformCss : interpolate_default3;
  return value == null ? this.styleTween(name, styleNull2(name, i)).on("end.style." + name, styleRemove5(name)) : typeof value === "function" ? this.styleTween(name, styleFunction5(name, i, tweenValue2(this, "style." + name, value))).each(styleMaybeRemove2(this._id, name)) : this.styleTween(name, styleConstant5(name, i, value), priority).on("end.style." + name, null);
}
...
function text_default6(value) {
  return this.tween("text", typeof value === "function" ? textFunction5(tweenValue2(this, "text", value)) : textConstant5(value == null ? "" : value + ""));
}
...
function textTween2(value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0) t0 = (i0 = i) && textInterpolate2(i);
    return t0;
  }
  tween._value = value;
  return tween;
...
selection_default.prototype.interrupt = interrupt_default4;
selection_default.prototype.transition = transition_default4;
...
//# sourceMappingURL=chunk-MZLAS4RB.js.map

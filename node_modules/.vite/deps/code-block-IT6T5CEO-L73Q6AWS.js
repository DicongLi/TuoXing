...
import {
  ...
  whitespace,
  zwitch
} from "./chunk-K36ON4N4.js";
import "./chunk-GKWT4OU3.js";
import "./chunk-GUWUQFPS.js";
import "./chunk-BBFN3SEK.js";
import "./chunk-U7P2NEEE.js";
import {
  require_jsx_runtime
} from "./chunk-AMH42PWU.js";
import {
  require_react
} from "./chunk-MPTPIO3S.js";
import {
  __toESM
} from "./chunk-DI52DQAC.js";

// node_modules/streamdown/dist/code-block-IT6T5CEO.js
...
var Theme = class {
  ...
  match(scopePath) {
    ...
    const effectiveRule = matchingTrieElements.find(
      (v3) => _scopePathMatchesParentScopes(scopePath.parent, v3.parentScopes)
    );
    if (!effectiveRule) {
      return null;
    }
...
function resolveParsedThemeRules(parsedThemeRules, _colorMap) {
  parsedThemeRules.sort((a2, b4) => {
    let r4 = strcmp(a2.scope, b4.scope);
    if (r4 !== 0) {
      return r4;
    }
    r4 = strArrCmp(a2.parentScopes, b4.parentScopes);
    if (r4 !== 0) {
      return r4;
    }
    return a2.index - b4.index;
  });
...
var ThemeTrieElement = class _ThemeTrieElement {
  ...
  static _cmpBySpecificity(a2, b4) {
    if (a2.scopeDepth !== b4.scopeDepth) {
      return b4.scopeDepth - a2.scopeDepth;
    }
    let aParentIndex = 0;
    let bParentIndex = 0;
    while (true) {
      ...
      if (aParentIndex >= a2.parentScopes.length || bParentIndex >= b4.parentScopes.length) {
        break;
      }
      const parentScopeLengthDiff = b4.parentScopes[bParentIndex].length - a2.parentScopes[aParentIndex].length;
    ...
    return b4.parentScopes.length - a2.parentScopes.length;
  }
  match(scope) {
    if (scope !== "") {
...
var AttributedScopeStack = class _AttributedScopeStack {
  ...
  static equals(a2, b4) {
    do {
      ...
      if (a2.scopeName !== b4.scopeName || a2.tokenAttributes !== b4.tokenAttributes) {
        return false;
      }
      a2 = a2.parent;
      b4 = b4.parent;
...
var StateStackImpl = class _StateStackImpl {
  ...
  static _equals(a2, b4) {
    if (a2 === b4) {
      return true;
    }
    if (!this._structuralEquals(a2, b4)) {
      return false;
    }
    return AttributedScopeStack.equals(a2.contentNameScopesList, b4.contentNameScopesList);
  }
  /**
   * A structural equals check. Does not take into account `scopes`.
   */
  static _structuralEquals(a2, b4) {
    do {
      if (a2 === b4) {
        return true;
      }
      ...
      if (a2.depth !== b4.depth || a2.ruleId !== b4.ruleId || a2.endRule !== b4.endRule) {
        return false;
      }
      a2 = a2.parent;
      b4 = b4.parent;
...
var BalancedBracketSelectors = class {
  ...
  constructor(balancedBracketScopes, unbalancedBracketScopes) {
    ...
    this.unbalancedBracketScopes = unbalancedBracketScopes.flatMap(
      (selector) => createMatchers(selector, nameMatcher).map((m4) => m4.matcher)
    );
  }
  get matchesAlways() {
...
function serializeAttribute(state, key2, value) {
  ...
  if (state.settings.preferUnquoted) {
    result = stringifyEntities(
      ...
      Object.assign({}, state.settings.characterReferences, {
        attribute: true,
        subset: constants.unquoted[x2][y4]
      })
    );
  }
  if (result !== value) {
    ...
    result = quote + stringifyEntities(
      ...
      Object.assign({}, state.settings.characterReferences, {
        // Always encode without parse errors in non-HTML.
        subset: (quote === "'" ? constants.single : constants.double)[x2][y4],
        attribute: true
      })
    ) + quote;
  }
...
function splitTokens(tokens, breakpoints) {
  const sorted = Array.from(breakpoints instanceof Set ? breakpoints : new Set(breakpoints)).sort((a2, b4) => a2 - b4);
  if (!sorted.length)
    return tokens;
  return tokens.map((line) => {
    return line.flatMap((token2) => {
      const breakpointsInToken = sorted.filter((i2) => token2.offset < i2 && i2 < token2.offset + token2.content.length).map((i2) => i2 - token2.offset).sort((a2, b4) => a2 - b4);
...
function transformerDecorations() {
      ...
      let normalizePosition = function(p3) {
        if (typeof p3 === "number") {
          if (p3 < 0 || p3 > shiki.source.length)
            throw new ShikiError(`Invalid decoration offset: ${p3}. Code length: ${shiki.source.length}`);
          return {
          ...
          if (line === void 0)
            throw new ShikiError(`Invalid decoration position ${JSON.stringify(p3)}. Lines length: ${converter.lines.length}`);
          let character = p3.character;
          if (character < 0)
            character = line.length + character;
          if (character < 0 || character > line.length)
            throw new ShikiError(`Invalid decoration position ${JSON.stringify(p3)}. Line ${p3.line} length: ${line.length}`);
          return {
            ...p3,
            character,
            offset: converter.posToIndex(p3.line, character)
          };
        }
      };
  ...
  return {
    ...
    code(codeEl) {
      ...
      const lineApplies = [];
      const sorted = ctx.decorations.sort((a2, b4) => b4.start.offset - a2.start.offset || a2.end.offset - b4.end.offset);
    ...
    for (let r4 = 0; r4 < 6; r4++) {
      for (let g2 = 0; g2 < 6; g2++) {
        for (let b4 = 0; b4 < 6; b4++) {
          colorTable.push(rgbColor([levels[r4], levels[g2], levels[b4]]));
        }
      }
    }
    let level = 8;
...
function dimColor(color) {
  ...
  if (hexMatch) {
    ...
    if (hex.length === 8) {
      ...
      return `#${r4}${r4}${g2}${g2}${b4}${b4}${alpha}`;
    } else if (hex.length === 3) {
      const r4 = hex[0];
      const g2 = hex[1];
      const b4 = hex[2];
      return `#${r4}${r4}${g2}${g2}${b4}${b4}80`;
    }
  }
...
function codeToTokens(internal, code, options) {
  ...
  if ("themes" in options) {
    ...
    const themes = Object.entries(options.themes).filter((i2) => i2[1]).map((i2) => ({ color: i2[0], theme: i2[1] })).sort((a2, b4) => a2.color === defaultColor ? -1 : b4.color === defaultColor ? 1 : 0);
    if (themes.length === 0)
...
var bundledLanguagesInfo = [
  {
    "id": "abap",
    "name": "ABAP",
    "import": (() => import("./abap-4FHYWR25.js"))
  },
  {
    "id": "actionscript-3",
    "name": "ActionScript",
    "import": (() => import("./actionscript-3-ZRHJS6XO.js"))
  },
  {
    "id": "ada",
    "name": "Ada",
    "import": (() => import("./ada-XGQ55YBF.js"))
  },
  {
    "id": "angular-html",
    "name": "Angular HTML",
    "import": (() => import("./angular-html-7DNJS6AP.js"))
  },
  {
    "id": "angular-ts",
    "name": "Angular TypeScript",
    "import": (() => import("./angular-ts-VCBRFAZD.js"))
  },
  {
    "id": "apache",
    "name": "Apache Conf",
    "import": (() => import("./apache-IVLAYWW5.js"))
  },
  {
    "id": "apex",
    "name": "Apex",
    "import": (() => import("./apex-NDRS47RE.js"))
  },
  {
    "id": "apl",
    "name": "APL",
    "import": (() => import("./apl-4AUYX454.js"))
  },
  {
    "id": "applescript",
    "name": "AppleScript",
    "import": (() => import("./applescript-XRKKNRO5.js"))
  },
  {
    "id": "ara",
    "name": "Ara",
    "import": (() => import("./ara-UDKHQFZ3.js"))
  },
  {
    "id": "asciidoc",
    "name": "AsciiDoc",
    ...
    "import": (() => import("./asciidoc-2G2XGIVF.js"))
  },
  {
    "id": "asm",
    "name": "Assembly",
    "import": (() => import("./asm-IFDRXQSJ.js"))
  },
  {
    "id": "astro",
    "name": "Astro",
    "import": (() => import("./astro-HSWPOEOX.js"))
  },
  {
    "id": "awk",
    "name": "AWK",
    "import": (() => import("./awk-ZZRKZSEH.js"))
  },
  {
    "id": "ballerina",
    "name": "Ballerina",
    "import": (() => import("./ballerina-7QXJXWWJ.js"))
  },
  {
    "id": "bat",
    "name": "Batch File",
    ...
    "import": (() => import("./bat-GKB4Q2G4.js"))
  },
  {
    "id": "beancount",
    "name": "Beancount",
    "import": (() => import("./beancount-GI33ML4U.js"))
  },
  {
    "id": "berry",
    "name": "Berry",
    ...
    "import": (() => import("./berry-V7FL6UTU.js"))
  },
  {
    "id": "bibtex",
    "name": "BibTeX",
    "import": (() => import("./bibtex-X562EAGM.js"))
  },
  {
    "id": "bicep",
    "name": "Bicep",
    "import": (() => import("./bicep-RZV2TKVV.js"))
  },
  {
    "id": "bird2",
    ...
    "import": (() => import("./bird2-WP5S3ER2.js"))
  },
  {
    "id": "blade",
    "name": "Blade",
    "import": (() => import("./blade-RWJYYJFW.js"))
  },
  {
    "id": "bsl",
    "name": "1C (Enterprise)",
    ...
    "import": (() => import("./bsl-O2NUXANE.js"))
  },
  {
    "id": "c",
    "name": "C",
    "import": (() => import("./c-OSAATTDT.js"))
  },
  {
    "id": "c3",
    "name": "C3",
    "import": (() => import("./c3-2UVLO7PS.js"))
  },
  {
    "id": "cadence",
    "name": "Cadence",
    ...
    "import": (() => import("./cadence-JWNV7Q7G.js"))
  },
  {
    "id": "cairo",
    "name": "Cairo",
    "import": (() => import("./cairo-V7FDK7SW.js"))
  },
  {
    "id": "clarity",
    "name": "Clarity",
    "import": (() => import("./clarity-NWBOFZNO.js"))
  },
  {
    "id": "clojure",
    "name": "Clojure",
    ...
    "import": (() => import("./clojure-5KKI6MQ7.js"))
  },
  {
    "id": "cmake",
    "name": "CMake",
    "import": (() => import("./cmake-DFU6JFO2.js"))
  },
  {
    "id": "cobol",
    "name": "COBOL",
    "import": (() => import("./cobol-KSCMZKAQ.js"))
  },
  {
    "id": "codeowners",
    "name": "CODEOWNERS",
    "import": (() => import("./codeowners-DDVAQLUY.js"))
  },
  {
    "id": "codeql",
    "name": "CodeQL",
    ...
    "import": (() => import("./codeql-EDRHG2KO.js"))
  },
  {
    "id": "coffee",
    "name": "CoffeeScript",
    ...
    "import": (() => import("./coffee-FPIW6EJN.js"))
  },
  {
    "id": "common-lisp",
    "name": "Common Lisp",
    ...
    "import": (() => import("./common-lisp-ULBJKDKS.js"))
  },
  {
    "id": "coq",
    "name": "Coq",
    "import": (() => import("./coq-X7BAKJ45.js"))
  },
  {
    "id": "cpp",
    "name": "C++",
    ...
    "import": (() => import("./cpp-GZ7PCPTN.js"))
  },
  {
    "id": "crystal",
    "name": "Crystal",
    "import": (() => import("./crystal-7TGGC5IV.js"))
  },
  {
    "id": "csharp",
    "name": "C#",
    ...
    "import": (() => import("./csharp-BLFVKN5S.js"))
  },
  {
    "id": "css",
    "name": "CSS",
    "import": (() => import("./css-N6YCDLPQ.js"))
  },
  {
    "id": "csv",
    "name": "CSV",
    "import": (() => import("./csv-Q6XTUEWT.js"))
  },
  {
    "id": "cue",
    "name": "CUE",
    "import": (() => import("./cue-RO5AOQ6X.js"))
  },
  {
    "id": "cypher",
    "name": "Cypher",
    ...
    "import": (() => import("./cypher-ZM4GTBUH.js"))
  },
  {
    "id": "d",
    "name": "D",
    "import": (() => import("./d-5PACDY3W.js"))
  },
  {
    "id": "dart",
    "name": "Dart",
    "import": (() => import("./dart-TPRAVQMC.js"))
  },
  {
    "id": "dax",
    "name": "DAX",
    "import": (() => import("./dax-PNLHYZPL.js"))
  },
  {
    "id": "desktop",
    "name": "Desktop",
    "import": (() => import("./desktop-VGOE3E33.js"))
  },
  {
    "id": "diff",
    "name": "Diff",
    "import": (() => import("./diff-SDWTGGJ7.js"))
  },
  {
    "id": "docker",
    "name": "Dockerfile",
    ...
    "import": (() => import("./docker-G7UY4K27.js"))
  },
  {
    "id": "dotenv",
    "name": "dotEnv",
    "import": (() => import("./dotenv-EMMGDXCQ.js"))
  },
  {
    "id": "dream-maker",
    "name": "Dream Maker",
    "import": (() => import("./dream-maker-5AEPROKQ.js"))
  },
  {
    "id": "edge",
    "name": "Edge",
    "import": (() => import("./edge-G6R3UU4L.js"))
  },
  {
    "id": "elixir",
    "name": "Elixir",
    "import": (() => import("./elixir-46THCGMJ.js"))
  },
  {
    "id": "elm",
    "name": "Elm",
    "import": (() => import("./elm-NTGD2EUK.js"))
  },
  {
    "id": "emacs-lisp",
    "name": "Emacs Lisp",
    ...
    "import": (() => import("./emacs-lisp-MIUKFYBT.js"))
  },
  {
    "id": "erb",
    "name": "ERB",
    "import": (() => import("./erb-7VPWDUJV.js"))
  },
  {
    "id": "erlang",
    "name": "Erlang",
    ...
    "import": (() => import("./erlang-7VBBIAHB.js"))
  },
  {
    "id": "fennel",
    "name": "Fennel",
    "import": (() => import("./fennel-M4PS4G3A.js"))
  },
  {
    "id": "fish",
    "name": "Fish",
    "import": (() => import("./fish-EJ473ORU.js"))
  },
  {
    "id": "fluent",
    "name": "Fluent",
    ...
    "import": (() => import("./fluent-6XEVBSWF.js"))
  },
  {
    ...
    "import": (() => import("./fortran-fixed-form-XSH6RIQ4.js"))
  },
  {
    ...
    "import": (() => import("./fortran-free-form-45YWUABN.js"))
  },
  {
    "id": "fsharp",
    "name": "F#",
    ...
    "import": (() => import("./fsharp-NSPDUQII.js"))
  },
  {
    "id": "gdresource",
    "name": "GDResource",
    ...
    "import": (() => import("./gdresource-H5BXTIA5.js"))
  },
  {
    "id": "gdscript",
    "name": "GDScript",
    ...
    "import": (() => import("./gdscript-UA3JFWPK.js"))
  },
  {
    "id": "gdshader",
    "name": "GDShader",
    "import": (() => import("./gdshader-I2BPYAVI.js"))
  },
  {
    "id": "genie",
    "name": "Genie",
    "import": (() => import("./genie-ZVKKS2R6.js"))
  },
  {
    "id": "gherkin",
    "name": "Gherkin",
    "import": (() => import("./gherkin-7A5FPENG.js"))
  },
  {
    "id": "git-commit",
    "name": "Git Commit Message",
    "import": (() => import("./git-commit-CBNR5FO2.js"))
  },
  {
    "id": "git-rebase",
    "name": "Git Rebase Message",
    "import": (() => import("./git-rebase-G4LDLIFX.js"))
  },
  {
    "id": "gleam",
    "name": "Gleam",
    "import": (() => import("./gleam-N5YGMTXX.js"))
  },
  {
    "id": "glimmer-js",
    "name": "Glimmer JS",
    ...
    "import": (() => import("./glimmer-js-CALXZW55.js"))
  },
  {
    "id": "glimmer-ts",
    "name": "Glimmer TS",
    ...
    "import": (() => import("./glimmer-ts-AF5QOLGH.js"))
  },
  {
    "id": "glsl",
    "name": "GLSL",
    "import": (() => import("./glsl-RGBCC4DE.js"))
  },
  {
    "id": "gn",
    "name": "GN",
    "import": (() => import("./gn-UYAU5R3E.js"))
  },
  {
    "id": "gnuplot",
    "name": "Gnuplot",
    "import": (() => import("./gnuplot-IYHARQ2W.js"))
  },
  {
    "id": "go",
    "name": "Go",
    "import": (() => import("./go-VVHJHDOJ.js"))
  },
  {
    "id": "graphql",
    "name": "GraphQL",
    ...
    "import": (() => import("./graphql-T7ZJFLHG.js"))
  },
  {
    "id": "groovy",
    "name": "Groovy",
    "import": (() => import("./groovy-VHMPUNZW.js"))
  },
  {
    "id": "hack",
    "name": "Hack",
    "import": (() => import("./hack-CO44BV5N.js"))
  },
  {
    "id": "haml",
    "name": "Ruby Haml",
    "import": (() => import("./haml-LNMX7UP5.js"))
  },
  {
    "id": "handlebars",
    "name": "Handlebars",
    ...
    "import": (() => import("./handlebars-IDEJQ2O5.js"))
  },
  {
    "id": "haskell",
    "name": "Haskell",
    ...
    "import": (() => import("./haskell-3NTJBGH3.js"))
  },
  {
    "id": "haxe",
    "name": "Haxe",
    "import": (() => import("./haxe-MJCRLL2J.js"))
  },
  {
    "id": "hcl",
    "name": "HashiCorp HCL",
    "import": (() => import("./hcl-CBVBRUUF.js"))
  },
  {
    "id": "hjson",
    "name": "Hjson",
    "import": (() => import("./hjson-QLSZQGGX.js"))
  },
  {
    "id": "hlsl",
    "name": "HLSL",
    "import": (() => import("./hlsl-EGGWFWVZ.js"))
  },
  {
    "id": "html",
    "name": "HTML",
    "import": (() => import("./html-X3Z4BXIS.js"))
  },
  {
    "id": "html-derivative",
    "name": "HTML (Derivative)",
    "import": (() => import("./html-derivative-R62ELAR2.js"))
  },
  {
    "id": "http",
    "name": "HTTP",
    "import": (() => import("./http-HG3COFAN.js"))
  },
  {
    "id": "hurl",
    "name": "Hurl",
    "import": (() => import("./hurl-KDPCDW2G.js"))
  },
  {
    "id": "hxml",
    "name": "HXML",
    "import": (() => import("./hxml-GUHHDYS5.js"))
  },
  {
    "id": "hy",
    "name": "Hy",
    "import": (() => import("./hy-WQZB7WGC.js"))
  },
  {
    "id": "imba",
    "name": "Imba",
    "import": (() => import("./imba-PX2CKSOH.js"))
  },
  {
    "id": "ini",
    "name": "INI",
    ...
    "import": (() => import("./ini-LAS6JCDK.js"))
  },
  {
    "id": "java",
    "name": "Java",
    "import": (() => import("./java-RYXGKGV4.js"))
  },
  {
    "id": "javascript",
    "name": "JavaScript",
    ...
    "import": (() => import("./javascript-UAPLRFIU.js"))
  },
  {
    "id": "jinja",
    "name": "Jinja",
    "import": (() => import("./jinja-YEV2JNXO.js"))
  },
  {
    "id": "jison",
    "name": "Jison",
    "import": (() => import("./jison-NRBTCFKT.js"))
  },
  {
    "id": "json",
    "name": "JSON",
    "import": (() => import("./json-YUW3ADWL.js"))
  },
  {
    "id": "json5",
    "name": "JSON5",
    "import": (() => import("./json5-JAOVLGAI.js"))
  },
  {
    "id": "jsonc",
    "name": "JSON with Comments",
    "import": (() => import("./jsonc-RJ7R2MFP.js"))
  },
  {
    "id": "jsonl",
    "name": "JSON Lines",
    "import": (() => import("./jsonl-Z4Z5M274.js"))
  },
  {
    "id": "jsonnet",
    "name": "Jsonnet",
    "import": (() => import("./jsonnet-ZI5T3SOB.js"))
  },
  {
    "id": "jssm",
    "name": "JSSM",
    ...
    "import": (() => import("./jssm-PHVY3PEQ.js"))
  },
  {
    "id": "jsx",
    "name": "JSX",
    "import": (() => import("./jsx-EGKZJEEN.js"))
  },
  {
    "id": "julia",
    "name": "Julia",
    ...
    "import": (() => import("./julia-ZROCFSFY.js"))
  },
  {
    "id": "just",
    "name": "Just",
    "import": (() => import("./just-7O2PHW73.js"))
  },
  {
    "id": "kdl",
    "name": "KDL",
    "import": (() => import("./kdl-ZDTT3TC7.js"))
  },
  {
    "id": "kotlin",
    "name": "Kotlin",
    ...
    "import": (() => import("./kotlin-HNQMYGU7.js"))
  },
  {
    "id": "kusto",
    "name": "Kusto",
    ...
    "import": (() => import("./kusto-V4AZQ6SS.js"))
  },
  {
    "id": "latex",
    "name": "LaTeX",
    "import": (() => import("./latex-H24SK37D.js"))
  },
  {
    "id": "lean",
    "name": "Lean 4",
    ...
    "import": (() => import("./lean-TXR2T4VC.js"))
  },
  {
    "id": "less",
    "name": "Less",
    "import": (() => import("./less-WL37VORK.js"))
  },
  {
    "id": "liquid",
    "name": "Liquid",
    "import": (() => import("./liquid-SGREJXG7.js"))
  },
  {
    "id": "llvm",
    "name": "LLVM IR",
    "import": (() => import("./llvm-EQS4M4SV.js"))
  },
  {
    "id": "log",
    "name": "Log file",
    "import": (() => import("./log-CKJEZXHB.js"))
  },
  {
    "id": "logo",
    "name": "Logo",
    "import": (() => import("./logo-VT6OZMPV.js"))
  },
  {
    "id": "lua",
    "name": "Lua",
    "import": (() => import("./lua-G7BMOREN.js"))
  },
  {
    "id": "luau",
    "name": "Luau",
    "import": (() => import("./luau-KVNKAULS.js"))
  },
  {
    "id": "make",
    "name": "Makefile",
    ...
    "import": (() => import("./make-V6W6BMW6.js"))
  },
  {
    "id": "markdown",
    "name": "Markdown",
    ...
    "import": (() => import("./markdown-EY6RJFOW.js"))
  },
  {
    "id": "marko",
    "name": "Marko",
    "import": (() => import("./marko-JK2NCISM.js"))
  },
  {
    "id": "matlab",
    "name": "MATLAB",
    "import": (() => import("./matlab-XOMIUWGU.js"))
  },
  {
    "id": "mdc",
    "name": "MDC",
    "import": (() => import("./mdc-AZOMKUHT.js"))
  },
  {
    "id": "mdx",
    "name": "MDX",
    "import": (() => import("./mdx-BIECR2OC.js"))
  },
  {
    "id": "mermaid",
    "name": "Mermaid",
    ...
    "import": (() => import("./mermaid-CJREKQG5.js"))
  },
  {
    "id": "mipsasm",
    "name": "MIPS Assembly",
    ...
    "import": (() => import("./mipsasm-BZM2YNFE.js"))
  },
  {
    "id": "mojo",
    "name": "Mojo",
    "import": (() => import("./mojo-YFU5TFWJ.js"))
  },
  {
    "id": "moonbit",
    "name": "MoonBit",
    ...
    "import": (() => import("./moonbit-J64UU242.js"))
  },
  {
    "id": "move",
    "name": "Move",
    "import": (() => import("./move-MLAYTUSN.js"))
  },
  {
    "id": "narrat",
    ...
    "import": (() => import("./narrat-EWFVARTE.js"))
  },
  {
    "id": "nextflow",
    "name": "Nextflow",
    ...
    "import": (() => import("./nextflow-RV6AV2XT.js"))
  },
  {
    "id": "nextflow-groovy",
    "name": "nextflow-groovy",
    "import": (() => import("./nextflow-groovy-OVAV7YR7.js"))
  },
  {
    "id": "nginx",
    "name": "Nginx",
    "import": (() => import("./nginx-YRMSOIPY.js"))
  },
  {
    "id": "nim",
    "name": "Nim",
    "import": (() => import("./nim-543P36IM.js"))
  },
  {
    "id": "nix",
    "name": "Nix",
    "import": (() => import("./nix-636RCK2P.js"))
  },
  {
    "id": "nushell",
    "name": "nushell",
    ...
    "import": (() => import("./nushell-LXKC6QXX.js"))
  },
  {
    "id": "objective-c",
    "name": "Objective-C",
    ...
    "import": (() => import("./objective-c-AIOCRGOL.js"))
  },
  {
    "id": "objective-cpp",
    "name": "Objective-C++",
    "import": (() => import("./objective-cpp-SNJHEDJO.js"))
  },
  {
    "id": "ocaml",
    "name": "OCaml",
    "import": (() => import("./ocaml-EMIJ7EZN.js"))
  },
  {
    "id": "odin",
    "name": "Odin",
    "import": (() => import("./odin-MN3PGHZC.js"))
  },
  {
    "id": "openscad",
    "name": "OpenSCAD",
    ...
    "import": (() => import("./openscad-WCUJXKBZ.js"))
  },
  {
    "id": "pascal",
    "name": "Pascal",
    "import": (() => import("./pascal-C2KMM5FM.js"))
  },
  {
    "id": "perl",
    "name": "Perl",
    "import": (() => import("./perl-DEQY2ZJO.js"))
  },
  {
    "id": "php",
    "name": "PHP",
    "import": (() => import("./php-V5W76E7C.js"))
  },
  {
    "id": "pkl",
    "name": "Pkl",
    "import": (() => import("./pkl-FTS6GDH4.js"))
  },
  {
    "id": "plsql",
    "name": "PL/SQL",
    "import": (() => import("./plsql-KRGBO5UN.js"))
  },
  {
    "id": "po",
    "name": "Gettext PO",
    ...
    "import": (() => import("./po-6WCIFBG6.js"))
  },
  {
    "id": "polar",
    "name": "Polar",
    "import": (() => import("./polar-WC4Q4OCO.js"))
  },
  {
    "id": "postcss",
    "name": "PostCSS",
    "import": (() => import("./postcss-G5WSSHRD.js"))
  },
  {
    "id": "powerquery",
    "name": "PowerQuery",
    "import": (() => import("./powerquery-YUZLVIJL.js"))
  },
  {
    "id": "powershell",
    "name": "PowerShell",
    ...
    "import": (() => import("./powershell-XDL54DRI.js"))
  },
  {
    "id": "prisma",
    "name": "Prisma",
    "import": (() => import("./prisma-VLMSBJVL.js"))
  },
  {
    "id": "prolog",
    "name": "Prolog",
    "import": (() => import("./prolog-I4VTDVM2.js"))
  },
  {
    "id": "proto",
    ...
    "import": (() => import("./proto-5K6N6WTE.js"))
  },
  {
    "id": "pug",
    "name": "Pug",
    ...
    "import": (() => import("./pug-4HRRVSW5.js"))
  },
  {
    "id": "puppet",
    "name": "Puppet",
    "import": (() => import("./puppet-3QLLTPTX.js"))
  },
  {
    "id": "purescript",
    "name": "PureScript",
    "import": (() => import("./purescript-SKGHIA2S.js"))
  },
  {
    "id": "python",
    "name": "Python",
    ...
    "import": (() => import("./python-JMRIPDWF.js"))
  },
  {
    "id": "qml",
    "name": "QML",
    "import": (() => import("./qml-KF2RW4BJ.js"))
  },
  {
    "id": "qmldir",
    "name": "QML Directory",
    "import": (() => import("./qmldir-DKBMMYKT.js"))
  },
  {
    "id": "qss",
    "name": "Qt Style Sheets",
    "import": (() => import("./qss-5VB2GFD5.js"))
  },
  {
    "id": "r",
    "name": "R",
    "import": (() => import("./r-JP266OLB.js"))
  },
  {
    "id": "racket",
    "name": "Racket",
    "import": (() => import("./racket-7XPTN2Y5.js"))
  },
  {
    "id": "raku",
    "name": "Raku",
    ...
    "import": (() => import("./raku-CTJRRN42.js"))
  },
  {
    "id": "razor",
    "name": "ASP.NET Razor",
    "import": (() => import("./razor-CDPLMKF5.js"))
  },
  {
    "id": "reg",
    "name": "Windows Registry Script",
    "import": (() => import("./reg-AFZ6BB4J.js"))
  },
  {
    "id": "regexp",
    "name": "RegExp",
    ...
    "import": (() => import("./regexp-QWHYT2EI.js"))
  },
  {
    "id": "rel",
    "name": "Rel",
    "import": (() => import("./rel-KX5AUR6E.js"))
  },
  {
    "id": "riscv",
    "name": "RISC-V",
    "import": (() => import("./riscv-WYLGLNQC.js"))
  },
  {
    "id": "ron",
    "name": "RON",
    "import": (() => import("./ron-FQ3ZSTRO.js"))
  },
  {
    "id": "rosmsg",
    "name": "ROS Interface",
    "import": (() => import("./rosmsg-26PP26GS.js"))
  },
  {
    "id": "rst",
    "name": "reStructuredText",
    "import": (() => import("./rst-MJ2I7EKO.js"))
  },
  {
    "id": "ruby",
    "name": "Ruby",
    ...
    "import": (() => import("./ruby-5ANXZKH5.js"))
  },
  {
    "id": "rust",
    "name": "Rust",
    ...
    "import": (() => import("./rust-H5OAW3AQ.js"))
  },
  {
    "id": "sas",
    "name": "SAS",
    "import": (() => import("./sas-F3XYRXVB.js"))
  },
  {
    "id": "sass",
    "name": "Sass",
    "import": (() => import("./sass-XUXIBCQI.js"))
  },
  {
    "id": "scala",
    "name": "Scala",
    "import": (() => import("./scala-MZV67I53.js"))
  },
  {
    "id": "scheme",
    "name": "Scheme",
    "import": (() => import("./scheme-NE2MUOMR.js"))
  },
  {
    "id": "scss",
    "name": "SCSS",
    "import": (() => import("./scss-7GQOR73D.js"))
  },
  {
    "id": "sdbl",
    "name": "1C (Query)",
    ...
    "import": (() => import("./sdbl-VZALEEFE.js"))
  },
  {
    "id": "shaderlab",
    "name": "ShaderLab",
    ...
    "import": (() => import("./shaderlab-BQ2CUQQM.js"))
  },
  {
    "id": "shellscript",
    "name": "Shell",
    ...
    "import": (() => import("./shellscript-NH555X26.js"))
  },
  {
    "id": "shellsession",
    "name": "Shell Session",
    ...
    "import": (() => import("./shellsession-DZXG3PQA.js"))
  },
  {
    "id": "smalltalk",
    "name": "Smalltalk",
    "import": (() => import("./smalltalk-PP3EPRAT.js"))
  },
  {
    "id": "solidity",
    "name": "Solidity",
    "import": (() => import("./solidity-BX7SGXDU.js"))
  },
  {
    "id": "soy",
    ...
    "import": (() => import("./soy-IL4Y6YMS.js"))
  },
  {
    "id": "sparql",
    "name": "SPARQL",
    "import": (() => import("./sparql-6E5NTKTG.js"))
  },
  {
    "id": "splunk",
    ...
    "import": (() => import("./splunk-NT2A4SKD.js"))
  },
  {
    "id": "sql",
    "name": "SQL",
    "import": (() => import("./sql-MTIMS432.js"))
  },
  {
    "id": "ssh-config",
    "name": "SSH Config",
    "import": (() => import("./ssh-config-NE7TR4HC.js"))
  },
  {
    "id": "stata",
    "name": "Stata",
    "import": (() => import("./stata-WR5SLBRI.js"))
  },
  {
    "id": "stylus",
    "name": "Stylus",
    ...
    "import": (() => import("./stylus-AV73K56P.js"))
  },
  {
    "id": "surrealql",
    "name": "SurrealQL",
    ...
    "import": (() => import("./surrealql-ZMRRZWUC.js"))
  },
  {
    "id": "svelte",
    "name": "Svelte",
    "import": (() => import("./svelte-BG3T66KM.js"))
  },
  {
    "id": "swift",
    "name": "Swift",
    "import": (() => import("./swift-YC4J45CR.js"))
  },
  {
    "id": "system-verilog",
    "name": "SystemVerilog",
    "import": (() => import("./system-verilog-Z4X2JJPD.js"))
  },
  {
    "id": "systemd",
    "name": "Systemd Units",
    "import": (() => import("./systemd-KYQFKOWG.js"))
  },
  {
    "id": "talonscript",
    "name": "TalonScript",
    ...
    "import": (() => import("./talonscript-BRI4CDYL.js"))
  },
  {
    "id": "tasl",
    "name": "Tasl",
    "import": (() => import("./tasl-IHR3U7KD.js"))
  },
  {
    "id": "tcl",
    "name": "Tcl",
    "import": (() => import("./tcl-CSL42CGR.js"))
  },
  {
    "id": "templ",
    "name": "Templ",
    "import": (() => import("./templ-F2ZMHXTY.js"))
  },
  {
    "id": "terraform",
    "name": "Terraform",
    ...
    "import": (() => import("./terraform-TJSRMK2X.js"))
  },
  {
    "id": "tex",
    "name": "TeX",
    "import": (() => import("./tex-FTQEMOUO.js"))
  },
  {
    "id": "toml",
    "name": "TOML",
    "import": (() => import("./toml-H4FSY44J.js"))
  },
  {
    "id": "ts-tags",
    ...
    "import": (() => import("./ts-tags-LEATJ56M.js"))
  },
  {
    "id": "tsv",
    "name": "TSV",
    "import": (() => import("./tsv-NE6JOE55.js"))
  },
  {
    "id": "tsx",
    "name": "TSX",
    "import": (() => import("./tsx-MWWTUFA2.js"))
  },
  {
    "id": "turtle",
    "name": "Turtle",
    "import": (() => import("./turtle-5K2OZKTS.js"))
  },
  {
    "id": "twig",
    "name": "Twig",
    "import": (() => import("./twig-HF7JDOGK.js"))
  },
  {
    "id": "typescript",
    "name": "TypeScript",
    ...
    "import": (() => import("./typescript-VOJW5VQG.js"))
  },
  {
    "id": "typespec",
    "name": "TypeSpec",
    ...
    "import": (() => import("./typespec-BNKYCOCD.js"))
  },
  {
    "id": "typst",
    "name": "Typst",
    ...
    "import": (() => import("./typst-K5BLHVBD.js"))
  },
  {
    "id": "v",
    "name": "V",
    "import": (() => import("./v-P3P56KC3.js"))
  },
  {
    "id": "vala",
    "name": "Vala",
    "import": (() => import("./vala-RLOMXUJZ.js"))
  },
  {
    "id": "vb",
    "name": "Visual Basic",
    ...
    "import": (() => import("./vb-3TC3HL5K.js"))
  },
  {
    "id": "verilog",
    "name": "Verilog",
    "import": (() => import("./verilog-7T3FXEMJ.js"))
  },
  {
    "id": "vhdl",
    "name": "VHDL",
    "import": (() => import("./vhdl-WJ7UGONA.js"))
  },
  {
    "id": "viml",
    "name": "Vim Script",
    ...
    "import": (() => import("./viml-PN6OM3DV.js"))
  },
  {
    "id": "vue",
    "name": "Vue",
    "import": (() => import("./vue-2GODWNVG.js"))
  },
  {
    "id": "vue-html",
    "name": "Vue HTML",
    "import": (() => import("./vue-html-4RKEKQFS.js"))
  },
  {
    "id": "vue-vine",
    "name": "Vue Vine",
    "import": (() => import("./vue-vine-WPYTQ6DI.js"))
  },
  {
    "id": "vyper",
    "name": "Vyper",
    ...
    "import": (() => import("./vyper-WWGPKLLK.js"))
  },
  {
    "id": "wasm",
    "name": "WebAssembly",
    "import": (() => import("./wasm-DYGXLPBJ.js"))
  },
  {
    "id": "wenyan",
    "name": "Wenyan",
    ...
    "import": (() => import("./wenyan-35TE2RJM.js"))
  },
  {
    "id": "wgsl",
    "name": "WGSL",
    "import": (() => import("./wgsl-BONGGCKM.js"))
  },
  {
    "id": "wikitext",
    "name": "Wikitext",
    ...
    "import": (() => import("./wikitext-JIQWN2VP.js"))
  },
  {
    "id": "wit",
    "name": "WebAssembly Interface Types",
    "import": (() => import("./wit-PNCNZVYY.js"))
  },
  {
    "id": "wolfram",
    "name": "Wolfram",
    ...
    "import": (() => import("./wolfram-6H6MCDCQ.js"))
  },
  {
    "id": "xml",
    "name": "XML",
    "import": (() => import("./xml-HHLWIXJO.js"))
  },
  {
    "id": "xsl",
    "name": "XSL",
    "import": (() => import("./xsl-NNYEF6YH.js"))
  },
  {
    "id": "yaml",
    "name": "YAML",
    ...
    "import": (() => import("./yaml-5B3MZA5I.js"))
  },
  {
    "id": "zenscript",
    "name": "ZenScript",
    "import": (() => import("./zenscript-VZ5EGMRY.js"))
  },
  {
    "id": "zig",
    "name": "Zig",
    "import": (() => import("./zig-ZQVGNPVB.js"))
  }
];
...
var bundledThemesInfo = [
  {
    ...
    "type": "dark",
    "import": (() => import("./andromeeda-CURFIYGI.js"))
  },
  {
    "id": "aurora-x",
    "displayName": "Aurora X",
    "type": "dark",
    "import": (() => import("./aurora-x-T7ACGC3X.js"))
  },
  {
    "id": "ayu-dark",
    "displayName": "Ayu Dark",
    "type": "dark",
    "import": (() => import("./ayu-dark-LB47CSIQ.js"))
  },
  {
    "id": "ayu-light",
    "displayName": "Ayu Light",
    "type": "light",
    "import": (() => import("./ayu-light-XEZDB4T6.js"))
  },
  {
    "id": "ayu-mirage",
    "displayName": "Ayu Mirage",
    "type": "dark",
    "import": (() => import("./ayu-mirage-BQBYSZ4Q.js"))
  },
  {
    "id": "catppuccin-frappe",
    "displayName": "Catppuccin Frappé",
    "type": "dark",
    "import": (() => import("./catppuccin-frappe-BR2HTHV6.js"))
  },
  {
    "id": "catppuccin-latte",
    "displayName": "Catppuccin Latte",
    "type": "light",
    "import": (() => import("./catppuccin-latte-WADIP6RD.js"))
  },
  {
    "id": "catppuccin-macchiato",
    "displayName": "Catppuccin Macchiato",
    "type": "dark",
    "import": (() => import("./catppuccin-macchiato-M635B2NQ.js"))
  },
  {
    "id": "catppuccin-mocha",
    "displayName": "Catppuccin Mocha",
    "type": "dark",
    "import": (() => import("./catppuccin-mocha-IUDR5WFP.js"))
  },
  {
    "id": "dark-plus",
    "displayName": "Dark Plus",
    "type": "dark",
    "import": (() => import("./dark-plus-75DLWIUB.js"))
  },
  {
    "id": "dracula",
    "displayName": "Dracula Theme",
    "type": "dark",
    "import": (() => import("./dracula-IQQ4TGRD.js"))
  },
  {
    "id": "dracula-soft",
    "displayName": "Dracula Theme Soft",
    "type": "dark",
    "import": (() => import("./dracula-soft-M7FQM4BX.js"))
  },
  {
    "id": "everforest-dark",
    "displayName": "Everforest Dark",
    "type": "dark",
    "import": (() => import("./everforest-dark-4DXRX5CS.js"))
  },
  {
    "id": "everforest-light",
    "displayName": "Everforest Light",
    "type": "light",
    "import": (() => import("./everforest-light-COCOX4EK.js"))
  },
  {
    "id": "github-dark",
    "displayName": "GitHub Dark",
    "type": "dark",
    "import": (() => import("./github-dark-WH5UA4HO.js"))
  },
  {
    "id": "github-dark-default",
    "displayName": "GitHub Dark Default",
    "type": "dark",
    "import": (() => import("./github-dark-default-2QG2WF5V.js"))
  },
  {
    "id": "github-dark-dimmed",
    "displayName": "GitHub Dark Dimmed",
    "type": "dark",
    "import": (() => import("./github-dark-dimmed-D4G753S7.js"))
  },
  {
    "id": "github-dark-high-contrast",
    "displayName": "GitHub Dark High Contrast",
    "type": "dark",
    "import": (() => import("./github-dark-high-contrast-3X6XT7QG.js"))
  },
  {
    "id": "github-light",
    "displayName": "GitHub Light",
    "type": "light",
    "import": (() => import("./github-light-DCKYYENU.js"))
  },
  {
    "id": "github-light-default",
    "displayName": "GitHub Light Default",
    "type": "light",
    "import": (() => import("./github-light-default-PT32MA4M.js"))
  },
  {
    "id": "github-light-high-contrast",
    "displayName": "GitHub Light High Contrast",
    "type": "light",
    "import": (() => import("./github-light-high-contrast-J4J7TS5X.js"))
  },
  {
    "id": "gruvbox-dark-hard",
    "displayName": "Gruvbox Dark Hard",
    "type": "dark",
    "import": (() => import("./gruvbox-dark-hard-QH5QMRDD.js"))
  },
  {
    "id": "gruvbox-dark-medium",
    "displayName": "Gruvbox Dark Medium",
    "type": "dark",
    "import": (() => import("./gruvbox-dark-medium-HOWVVNHB.js"))
  },
  {
    "id": "gruvbox-dark-soft",
    "displayName": "Gruvbox Dark Soft",
    "type": "dark",
    "import": (() => import("./gruvbox-dark-soft-REWJ6RFV.js"))
  },
  {
    "id": "gruvbox-light-hard",
    "displayName": "Gruvbox Light Hard",
    "type": "light",
    "import": (() => import("./gruvbox-light-hard-KV6ZCBCJ.js"))
  },
  {
    "id": "gruvbox-light-medium",
    "displayName": "Gruvbox Light Medium",
    "type": "light",
    "import": (() => import("./gruvbox-light-medium-42Q2VC7X.js"))
  },
  {
    "id": "gruvbox-light-soft",
    "displayName": "Gruvbox Light Soft",
    "type": "light",
    "import": (() => import("./gruvbox-light-soft-2777WLQC.js"))
  },
  {
    "id": "horizon",
    "displayName": "Horizon",
    "type": "dark",
    "import": (() => import("./horizon-FSHJCZ36.js"))
  },
  {
    "id": "horizon-bright",
    "displayName": "Horizon Bright",
    "type": "dark",
    "import": (() => import("./horizon-bright-LHVZ62QY.js"))
  },
  {
    "id": "houston",
    "displayName": "Houston",
    "type": "dark",
    "import": (() => import("./houston-GBUCKQTT.js"))
  },
  {
    "id": "kanagawa-dragon",
    "displayName": "Kanagawa Dragon",
    "type": "dark",
    "import": (() => import("./kanagawa-dragon-AX227DHL.js"))
  },
  {
    "id": "kanagawa-lotus",
    "displayName": "Kanagawa Lotus",
    "type": "light",
    "import": (() => import("./kanagawa-lotus-OVALOXI7.js"))
  },
  {
    "id": "kanagawa-wave",
    "displayName": "Kanagawa Wave",
    "type": "dark",
    "import": (() => import("./kanagawa-wave-AA4CIHCY.js"))
  },
  {
    "id": "laserwave",
    "displayName": "LaserWave",
    "type": "dark",
    "import": (() => import("./laserwave-FRG4LL36.js"))
  },
  {
    "id": "light-plus",
    "displayName": "Light Plus",
    "type": "light",
    "import": (() => import("./light-plus-RQTDAA7S.js"))
  },
  {
    "id": "material-theme",
    "displayName": "Material Theme",
    "type": "dark",
    "import": (() => import("./material-theme-RL7CRPEU.js"))
  },
  {
    "id": "material-theme-darker",
    "displayName": "Material Theme Darker",
    "type": "dark",
    "import": (() => import("./material-theme-darker-7VWZGNJG.js"))
  },
  {
    "id": "material-theme-lighter",
    "displayName": "Material Theme Lighter",
    "type": "light",
    "import": (() => import("./material-theme-lighter-7CJKCPNI.js"))
  },
  {
    "id": "material-theme-ocean",
    "displayName": "Material Theme Ocean",
    "type": "dark",
    "import": (() => import("./material-theme-ocean-RCIB3RH3.js"))
  },
  {
    "id": "material-theme-palenight",
    "displayName": "Material Theme Palenight",
    "type": "dark",
    "import": (() => import("./material-theme-palenight-TVEZWGJ7.js"))
  },
  {
    "id": "min-dark",
    "displayName": "Min Dark",
    "type": "dark",
    "import": (() => import("./min-dark-FAE3AJZ3.js"))
  },
  {
    "id": "min-light",
    "displayName": "Min Light",
    "type": "light",
    "import": (() => import("./min-light-M4F3YINQ.js"))
  },
  {
    "id": "monokai",
    "displayName": "Monokai",
    "type": "dark",
    "import": (() => import("./monokai-AVKPSP6S.js"))
  },
  {
    "id": "night-owl",
    "displayName": "Night Owl",
    "type": "dark",
    "import": (() => import("./night-owl-YDYHQCSD.js"))
  },
  {
    "id": "night-owl-light",
    "displayName": "Night Owl Light",
    "type": "light",
    "import": (() => import("./night-owl-light-MIKIMJJB.js"))
  },
  {
    "id": "nord",
    "displayName": "Nord",
    "type": "dark",
    "import": (() => import("./nord-4YLBXOTV.js"))
  },
  {
    "id": "one-dark-pro",
    "displayName": "One Dark Pro",
    "type": "dark",
    "import": (() => import("./one-dark-pro-KTJ32W24.js"))
  },
  {
    "id": "one-light",
    "displayName": "One Light",
    "type": "light",
    "import": (() => import("./one-light-NMYZ4VCH.js"))
  },
  {
    "id": "plastic",
    "displayName": "Plastic",
    "type": "dark",
    "import": (() => import("./plastic-7RINUWHE.js"))
  },
  {
    "id": "poimandres",
    "displayName": "Poimandres",
    "type": "dark",
    "import": (() => import("./poimandres-4DUBXIIU.js"))
  },
  {
    "id": "red",
    "displayName": "Red",
    "type": "dark",
    "import": (() => import("./red-RCQCW34C.js"))
  },
  {
    "id": "rose-pine",
    "displayName": "Rosé Pine",
    "type": "dark",
    "import": (() => import("./rose-pine-WJCRDGRU.js"))
  },
  {
    "id": "rose-pine-dawn",
    "displayName": "Rosé Pine Dawn",
    "type": "light",
    "import": (() => import("./rose-pine-dawn-VGZFSM6E.js"))
  },
  {
    "id": "rose-pine-moon",
    "displayName": "Rosé Pine Moon",
    "type": "dark",
    "import": (() => import("./rose-pine-moon-N6I3MWYQ.js"))
  },
  {
    "id": "slack-dark",
    "displayName": "Slack Dark",
    "type": "dark",
    "import": (() => import("./slack-dark-7YHLEFTK.js"))
  },
  {
    "id": "slack-ochin",
    "displayName": "Slack Ochin",
    "type": "light",
    "import": (() => import("./slack-ochin-YTOB2ZTH.js"))
  },
  {
    "id": "snazzy-light",
    "displayName": "Snazzy Light",
    "type": "light",
    "import": (() => import("./snazzy-light-M5ZG2K7J.js"))
  },
  {
    "id": "solarized-dark",
    "displayName": "Solarized Dark",
    "type": "dark",
    "import": (() => import("./solarized-dark-R4NNIXV3.js"))
  },
  {
    "id": "solarized-light",
    "displayName": "Solarized Light",
    "type": "light",
    "import": (() => import("./solarized-light-YD7V463H.js"))
  },
  {
    "id": "synthwave-84",
    "displayName": "Synthwave '84",
    "type": "dark",
    "import": (() => import("./synthwave-84-YMIXH4YH.js"))
  },
  {
    "id": "tokyo-night",
    "displayName": "Tokyo Night",
    "type": "dark",
    "import": (() => import("./tokyo-night-J5CMFVW4.js"))
  },
  {
    "id": "vesper",
    "displayName": "Vesper",
    "type": "dark",
    "import": (() => import("./vesper-CSVZ2UBG.js"))
  },
  {
    "id": "vitesse-black",
    "displayName": "Vitesse Black",
    "type": "dark",
    "import": (() => import("./vitesse-black-5BXCKLLF.js"))
  },
  {
    "id": "vitesse-dark",
    "displayName": "Vitesse Dark",
    "type": "dark",
    "import": (() => import("./vitesse-dark-RRIHEKCR.js"))
  },
  {
    "id": "vitesse-light",
    "displayName": "Vitesse Light",
    "type": "light",
    "import": (() => import("./vitesse-light-ZP3RCUJE.js"))
  }
];
...
var createHighlighter = createBundledHighlighter({
  ...
  engine: () => createOnigurumaEngine(import("./wasm-IKKYGSJ4.js"))
});
var {
...
function M(e, n = {}) {
  ...
  const o3 = Y(t.flags), s2 = [o3.extended], a2 = { captureGroup: t.rules.captureGroup, getCurrentModX() {
    ...
    s2.push(u3);
  }, replaceCurrentModX(u3) {
    s2[s2.length - 1] = u3;
  }, singleline: t.rules.singleline };
  let r4 = [], i2;
  for (C2.lastIndex = 0; i2 = C2.exec(e); ) {
    const u3 = F(a2, e, i2[0], C2.lastIndex);
    u3.tokens ? r4.push(...u3.tokens) : u3.token && r4.push(u3.token), u3.lastIndex !== void 0 && (C2.lastIndex = u3.lastIndex);
  }
  const l3 = [];
  let c = 0;
  r4.filter((u3) => u3.type === "GroupOpen").forEach((u3) => {
    u3.kind === "capturing" ? u3.number = ++c : u3.raw === "(" && l3.push(u3);
  }), c || l3.forEach((u3, S2) => {
    u3.kind = "capturing", u3.number = S2 + 1;
  });
  const g2 = c || l3.length;
  return { tokens: r4.map((u3) => u3.type === "EscapedNumber" ? ee(u3, g2) : u3).flat(), flags: o3 };
}
function F(e, n, t, o3) {
  const [s2, a2] = t;
  if (t === "[" || t === "[^") {
...
function I(e, n, t = {}) {
  return e === "keep" ? { type: "Directive", kind: e, raw: n } : { type: "Directive", kind: e, flags: u2(t.flags), raw: n };
}
function W(e, n) {
...
function j(e) {
  ...
  const a2 = s2 ? s2.split(",").filter((g2) => g2 !== "").map((g2) => /^[+-]?\d+$/.test(g2) ? +g2 : g2) : [], [r4, i2, l3] = a2, c = B.has(t) ? t.toLowerCase() : "custom";
  switch (c) {
    case "fail":
    case "mismatch":
    case "skip":
...
function J2(e, r4 = {}) {
  const n = { flags: "", normalizeUnknownPropertyNames: false, skipBackrefValidation: false, skipLookbehindValidation: false, skipPropertyNameValidation: false, unicodePropertyMap: null, ...r4, rules: { captureGroup: false, singleline: false, ...r4.rules } }, t = M(e, { flags: n.flags, rules: { captureGroup: n.rules.captureGroup, singleline: n.rules.singleline } }), s2 = (p3, N) => {
    const u3 = t.tokens[o3.nextIndex];
    switch (o3.parent = p3, o3.nextIndex++, u3.type) {
      case "Alternator":
        return b2();
      case "Assertion":
        return W2(u3);
      case "Backreference":
        return X2(u3, o3);
      case "Character":
        return m2(u3.value, { useLastValid: !!N.isCheckingRangeEnd });
      ...
      case "CharacterSet":
        return ne(u3, o3);
      case "Directive":
        return I2(u3.kind, { flags: u3.flags });
      case "GroupOpen":
        return te2(u3, o3, N);
      case "NamedCallout":
        return U2(u3.kind, u3.tag, u3.arguments);
      case "Quantifier":
        return oe(u3, o3);
      case "Subroutine":
        return ae(u3, o3);
      default:
        throw new Error(`Unexpected token type "${u3.type}"`);
    }
  ...
  for (; o3.nextIndex < t.tokens.length; ) {
    const p3 = s2(d2, {});
    p3.type === "Alternative" ? (i2.body.push(p3), d2 = p3) : d2.body.push(p3);
  }
  ...
  for (const { ref: p3 } of f3) if (typeof p3 == "number") {
    if (p3 > a2.length) throw new Error("Subroutine uses a group number that's not defined");
    p3 && (a2[p3 - 1].isSubroutined = true);
  } else if (c.has(p3)) {
    if (c.get(p3).length > 1) throw new Error(o`Subroutine uses a duplicate group name "\g<${p3}>"`);
    c.get(p3)[0].isSubroutined = true;
  } else throw new Error(o`Subroutine uses a group name that's not defined "\g<${p3}>"`);
  return i2;
}
function W2({ kind: e }) {
  return F2(u2({ "^": "line_start", $: "line_end", "\\A": "string_start", "\\b": "word_boundary", "\\B": "word_boundary", "\\G": "search_start", "\\y": "text_segment_boundary", "\\Y": "text_segment_boundary", "\\z": "string_end", "\\Z": "string_end_newline" }[e], `Unexpected assertion kind "${e}"`), { negate: e === o`\B` || e === o`\Y` });
}
...
function re({ negate: e }, r4, n) {
  const { tokens: t, walk: s2 } = r4, o3 = t[r4.nextIndex], i2 = [C3()];
  let d2 = z2(o3);
  for (; d2.type !== "CharacterClassClose"; ) {
    if (d2.type === "CharacterClassIntersector") i2.push(C3()), r4.nextIndex++;
    else {
      const l3 = i2.at(-1);
...
function te2(e, r4, n) {
  ...
  let p3 = D2(t[r4.nextIndex]);
  for (; p3.type !== "GroupClose"; ) {
    if (p3.type === "Alternator") a2.body.push(b2()), r4.nextIndex++;
    else {
      const N = a2.body.at(-1), u3 = d2(N, { ...n, isInAbsenceFunction: n.isInAbsenceFunction || l3, isInLookbehind: n.isInLookbehind || c, isInNegLookbehind: n.isInNegLookbehind || f3 });
      if (N.body.push(u3), (c || n.isInLookbehind) && !i2) {
        const v3 = "Lookbehind includes a pattern not allowed by Oniguruma";
        if (f3 || n.isInNegLookbehind) {
          if (M2(u3) || u3.type === "CapturingGroup") throw new Error(v3);
        } else if (M2(u3) || $2(u3) && u3.negate) throw new Error(v3);
      }
    }
    p3 = D2(t[r4.nextIndex]);
  }
...
function I2(e, r4 = {}) {
  ...
  if (e === "flags") return { type: "Directive", kind: e, flags: u2(r4.flags) };
...
function z2(e, r4) {
  return u2(e, `${r4?.type === "Character" && r4.value === 93 ? "Empty" : "Unclosed"} character class`);
}
function D2(e) {
  return u2(e, "Unclosed group");
}

// node_modules/oniguruma-parser/dist/traverser/traverse.js
function S(a2, v3, N = null) {
  function u3(e, s2) {
    for (let t = 0; t < e.length; t++) {
  ...
  function n(e, s2 = null, t = null, r4 = null) {
    ...
    const d2 = { node: e, parent: s2, key: t, container: r4, root: a2, remove() {
      ...
      const b4 = !!y4.traverse;
      r4 ? r4[Math.max(0, l2(t) + i2)] = o3 : u2(s2, "Can't replace root node")[t] = o3, b4 && n(o3, s2, t, r4), c = true;
    }, replaceWithMultiple(o3, y4 = {}) {
      const b4 = !!y4.traverse;
      if (f2(r4).splice(Math.max(0, l2(t) + i2), 1, ...o3), i2 += o3.length - 1, b4) {
        let g2 = 0;
        for (let x2 = 0; x2 < o3.length; x2++) g2 += n(o3[x2], s2, l2(t) + x2 + g2, r4);
      }
      c = true;
    }, skip() {
      c = true;
    } }, { type: m4 } = e, h3 = v3["*"], p3 = v3[m4], R3 = typeof h3 == "function" ? h3 : h3?.enter, P3 = typeof p3 == "function" ? p3 : p3?.enter;
    if (R3?.(d2, N), P3?.(d2, N), !c) switch (m4) {
      ...
      case "Quantifier":
        ...
        break;
      case "Regex":
        u3(e.body, e), n(e.flags, e, "flags");
        break;
      default:
        throw new Error(`Unexpected node type "${m4}"`);
    }
    return p3?.exit?.(d2, N), h3?.exit?.(d2, N), i2;
  }
  return n(a2), a2;
}
function f2(a2) {
...
function atomic(expression, data) {
  ...
  do {
    ...
    while (match = atomicPluginToken.exec(expression)) {
      const { 0: m4, index, groups: { capturingStart, noncapturingStart } } = match;
      if (m4 === "[") {
        numCharClassesOpen++;
      } else if (!numCharClassesOpen) {
        if (m4 === aGDelim && !inAG) {
  ...
  expression = replaceUnescaped(
    ...
    ({ 0: m4, groups: { backrefNum, wrappedBackrefNum } }) => {
      if (backrefNum) {
        const bNum = +backrefNum;
        if (bNum > captureNumMap.length - 1) {
          throw new Error(`Backref "${m4}" greater than number of captures`);
        }
...
function possessive(expression) {
  ...
  while (match = possessivePluginToken.exec(expression)) {
    const { 0: m4, index, groups: { qBase, qMod, invalidQ } } = match;
    if (m4 === "[") {
      ...
      if (qMod === "+" && lastToken && !lastToken.startsWith("(")) {
        if (invalidQ) {
          throw new Error(`Invalid quantifier "${m4}"`);
        }
        let charsAdded = -1;
        if (/^\{\d+\}$/.test(qBase)) {
          ...
          if (lastToken === ")" || lastToken === "]") {
            ...
            expression = `${expression.slice(0, nodeIndex)}(?>${expression.slice(nodeIndex, index)}${qBase})${expression.slice(index + m4.length)}`;
          } else {
            expression = `${expression.slice(0, index - lastToken.length)}(?>${lastToken}${qBase})${expression.slice(index + m4.length)}`;
          }
          charsAdded += 4;
        }
...
function recursion(pattern, data) {
  ...
  while (match = token.exec(pattern)) {
    const { 0: m4, groups: { captureName, rDepth, gRNameOrNum, gRDepth } } = match;
    if (m4 === "[") {
      numCharClassesOpen++;
    } else if (!numCharClassesOpen) {
      if (rDepth) {
        ...
        const groupContentsRight = groupContents.slice(groupContentsLeft.length + m4.length);
        ...
        token.lastIndex += expansion.length - m4.length - groupContentsLeft.length - groupContentsRight.length;
...
function repeatWithDepth(pattern, direction, reps, namesInRecursed, hiddenCaptures, addedHiddenCaptures, numCapturesPassed) {
  ...
  for (let i2 = 0; i2 < reps; i2++) {
    ...
    result += replaceUnescaped(
      ...
      ({ 0: m4, groups: { captureName, unnamed, backref } }) => {
        ...
        if (unnamed || captureName) {
          ...
          return unnamed ? m4 : `(?<${captureName}${suffix}>`;
        }
...
White_Space space
XID_Continue XIDC
XID_Start XIDS`.split(/\s/).map((p3) => [w2(p3), p3])
);
  ...
  Assertion({ node, parent, key: key2, container, root: root2, remove, replaceWith }, state) {
    ...
    if (kind === "text_segment_boundary") {
      ...
      if (!wordIsAscii && !asciiWordBoundaries) {
        const b4 = `(?:(?<=${defaultWordChar})(?!${defaultWordChar})|(?<!${defaultWordChar})(?=${defaultWordChar}))`;
        const B3 = `(?:(?<=${defaultWordChar})(?=${defaultWordChar})|(?<!${defaultWordChar})(?!${defaultWordChar}))`;
        replaceWith(setParentDeep(parseFragment(negate ? B3 : b4), parent));
      }
    } else {
...
function areFlagsEqual(a2, b4) {
  return a2.dotAll === b4.dotAll && a2.ignoreCase === b4.ignoreCase;
}
...
function getCodePointRangesFromChars(chars) {
  const codePoints = chars.map((char) => char.codePointAt(0)).sort((a2, b4) => a2 - b4);
  const values = [];
  let start = null;
...
function createNameMap(pattern) {
  ...
  while (match = re2.exec(pattern)) {
    const { 0: m4, groups: { capture, name } } = match;
    if (m4 === "[") {
      numCharClassesOpen++;
    } else if (!numCharClassesOpen) {
      if (capture) {
...
function toRegExpDetails(pattern, options) {
  ...
  if (opts.avoidSubclass) {
    ...
    const hiddenCaptures = atomicResult.hiddenCaptures.sort((a2, b4) => a2 - b4);
...
var JavaScriptScanner = class {
  constructor(patterns, options = {}) {
    ...
    this.regexps = patterns.map((p3) => {
      if (typeof p3 !== "string") {
        return p3;
      }
      const cached = cache?.get(p3);
      if (cached) {
      ...
      try {
        const regex = regexConstructor(p3);
        cache?.set(p3, regex);
        return regex;
      } catch (e) {
        cache?.set(p3, e);
  ...
  findNextMatchSync(string, startPosition, _options) {
    ...
    if (pending.length) {
      const minIndex = Math.min(...pending.map((m4) => m4[1].index));
...
// node_modules/streamdown/dist/code-block-IT6T5CEO.js
var v2 = u("block", "before:content-[counter(line)]", "before:inline-block", "before:[counter-increment:line]", "before:w-4", "before:mr-4", "before:text-[13px]", "before:text-right", "before:text-muted-foreground/50", "before:font-mono", "before:select-none");
var b3 = (0, import_react.memo)(({ children: e, result: t, language: o3, className: r4, ...s2 }) => {
  let n = (0, import_react.useMemo)(() => ({ backgroundColor: t.bg, color: t.fg }), [t.bg, t.fg]);
  return (0, import_jsx_runtime.jsx)("pre", { className: u(r4, "p-4 text-sm dark:bg-(--shiki-dark-bg)!"), "data-language": o3, "data-streamdown": "code-block-body", style: n, ...s2, children: (0, import_jsx_runtime.jsx)("code", { className: "[counter-increment:line_0] [counter-reset:line]", children: t.tokens.map((l3, d2) => (0, import_jsx_runtime.jsx)("span", { className: v2, children: l3.map((a2, i2) => (0, import_jsx_runtime.jsx)("span", { className: "dark:bg-(--shiki-dark-bg)! dark:text-(--shiki-dark)!", style: { color: a2.color, backgroundColor: a2.bgColor, ...a2.htmlStyle }, ...a2.htmlAttrs, children: a2.content }, i2)) }, d2)) }) });
}, (e, t) => e.result === t.result && e.language === t.language && e.className === t.className);
var y3 = ({ className: e, language: t, style: o3, ...r4 }) => (0, import_jsx_runtime.jsx)("div", { className: u("my-4 w-full overflow-hidden rounded-xl border border-border", e), "data-language": t, "data-streamdown": "code-block", style: { contentVisibility: "auto", containIntrinsicSize: "auto 200px", ...o3 }, ...r4 });
var L3 = ({ language: e, children: t }) => (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between bg-muted/80 p-3 text-muted-foreground text-xs", "data-language": e, "data-streamdown": "code-block-header", children: [(0, import_jsx_runtime.jsx)("span", { className: "ml-1 font-mono lowercase", children: e }), (0, import_jsx_runtime.jsx)("div", { className: "flex items-center gap-2", children: t })] });
var $3 = createJavaScriptRegexEngine({ forgiving: true });
var m3 = /* @__PURE__ */ new Map();
var p2 = /* @__PURE__ */ new Map();
var g = /* @__PURE__ */ new Map();
var E3 = (e, t) => `${e}-${t[0]}-${t[1]}`;
var A3 = (e, t, o3) => {
  let r4 = e.slice(0, 100), s2 = e.length > 100 ? e.slice(-100) : "";
  return `${t}:${o3[0]}:${o3[1]}:${e.length}:${r4}:${s2}`;
};
var T3 = (e) => Object.hasOwn(bundledLanguages, e);
var K3 = (e, t) => {
  let o3 = T3(e) ? e : "text", r4 = E3(o3, t);
  if (m3.has(r4)) return m3.get(r4);
  let s2 = createHighlighter({ themes: t, langs: [o3], engine: $3 });
  return m3.set(r4, s2), s2;
};
var h2 = (e, t, o3, r4) => {
  let s2 = T3(t) ? t : "text", n = A3(e, s2, o3);
  return p2.has(n) ? p2.get(n) : (r4 && (g.has(n) || g.set(n, /* @__PURE__ */ new Set()), g.get(n).add(r4)), K3(s2, o3).then((l3) => {
    let d2 = l3.codeToTokens(e, { lang: s2, themes: { light: o3[0], dark: o3[1] } });
    p2.set(n, d2);
    let a2 = g.get(n);
    if (a2) {
      for (let i2 of a2) i2(d2);
      g.delete(n);
    }
  }).catch((l3) => {
    console.error("Failed to highlight code:", l3), g.delete(n);
  }), null);
};
var le = ({ code: e, language: t, className: o3, children: r4, ...s2 }) => {
  let { shikiTheme: n } = (0, import_react.useContext)(C), l3 = (0, import_react.useMemo)(() => ({ bg: "transparent", fg: "inherit", tokens: e.split(`
`).map((i2) => [{ content: i2, color: "inherit", bgColor: "transparent", htmlStyle: {}, offset: 0 }]) }), [e]), [d2, a2] = (0, import_react.useState)(l3);
  ...
  }, [e, t, n]), (0, import_jsx_runtime.jsx)(Dt.Provider, { value: { code: e }, children: (0, import_jsx_runtime.jsxs)(y3, { language: t, children: [(0, import_jsx_runtime.jsx)(L3, { language: t, children: r4 }), (0, import_jsx_runtime.jsx)(b3, { className: o3, language: t, result: d2, ...s2 })] }) });
};
export {
  le as CodeBlock
};
//# sourceMappingURL=code-block-IT6T5CEO-L73Q6AWS.js.map
